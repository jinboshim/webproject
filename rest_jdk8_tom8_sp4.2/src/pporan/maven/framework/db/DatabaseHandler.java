...
public class DatabaseHandler {
	...
	public void setTiberoCommonDao(CommonDao tiberoCommonDao) {
		this.tiberoCommonDao = tiberoCommonDao;
	}
	...
	public CommonDao getCommonDao(int dbtype) {
		...
		else if(dbtype == DB_TIBERO){
			return tiberoCommonDao;
		}
		else{
			return oracleCommonDao;
		}
